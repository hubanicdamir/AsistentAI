...
class DetectionGUI:
    ...
    def create_gui(self):
        ...
        ttk.Button(toolbar, text='📷', width=3, command=self.toggle_camera).pack(side=tk.LEFT, padx=2)
        ttk.Button(toolbar, text='✎', width=3, command=self.start_learning).pack(side=tk.LEFT, padx=2)
        ttk.Button(toolbar, text='📝', width=3, command=self.describe_scene).pack(side=tk.LEFT, padx=2)
